...
const runtimeBtn = document.querySelector('#runtime-btn');
...
sortAlgorithm.addEventListener('change', runtimeBtnActive);
...
function sortByCol(col){
  ...
  let sortOrdered = storedSortOrder == 'descending' ? 'ascending' : 'descending'
  localStorage.setItem('sortOrder', sortOrdered);
...
function runtimeBtnActive(){
  runtimeBtn.classList.add('active')
  setTimeout(function() {
  runtimeBtn.classList.remove('active');}, 5000)
}
